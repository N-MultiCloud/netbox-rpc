...
_MAX_OUTPUT = 64 * 1024
# Best-effort schema defense in depth. Runtime normalization additionally parses
# YAML and inspects decoded keys before RPCExecution.params is persisted.
...
AKVORADO_PROCEDURES = (
    ...
    },
    {
        ...
        "target_models": _TARGET_MODELS,
        "effect": "write",
        # Handler's own sequential budget: mkdir 30 + write_env 30 +
        # write_compose 30 + compose_up 240 + compose_ps 45 = 375s.
        "timeout_seconds": 420,
        "approval_required": True,
        "transport_driver": "asyncssh",
        "transport_driver_chain": [],
